...
jQuery(document).ready(function () {
    ...
    var shrinked_header_height = 64,
        ...
        navItems = jQuery('.navbar ul a[href^="/Home/Index"]').not('.navbar ul a[href="#"], .navbar ul a.fancybox-inline');
    ...
    if (location.href.endsWith("Blog")) {
        ...
        jQuery('.navbar ul a[href="/Home/Blog"]').parent('li').addClass('current');
    } else {
        ...
        jQuery(window).scroll(function () {
            ...
            navItems.each(function () {
                var thisHref = '#' + jQuery(this).attr('href').split('#')[1];
                if (jQuery(thisHref).length) {
                    thisTruePosition = parseInt(jQuery(thisHref).offset().top, 0);
                    thisPosition = thisTruePosition - headerWrapper - offsetTolerance;
                    if (scrollPosition >= thisPosition) {
                        jQuery('.current').removeClass('current');
                        jQuery('.navbar ul a[href="/Home/Index' + thisHref + '"]').parent('li').addClass('current');
                    }
                }
            });
...
(function ($, window, document, undefined) {
    ...
    gridContainer.cubeportfolio({
        ...
        singlePageCallback: function (url, element) {
            // to update singlePage content use t+he following method: this.updateSinglePage(yourContent)
